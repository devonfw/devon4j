 ...
 *        Typically implementing {@link com.devonfw.module.jpa.dataaccess.api.PersistenceEntity}.
 *
 * @since 3.0.0
 */
public interface FeatureForceIncrementModificationCounter<E> {
  ...
  /**
   * Enforces to increment the {@link com.devonfw.module.jpa.dataaccess.api.PersistenceEntity#getModificationCounter()
