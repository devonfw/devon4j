 ...
 */
@Named
public class JwtManagerImpl implements JwtManager, io.jsonwebtoken.Clock {
  ...
  public Jws<Claims> decode(String jwt) {
    ...
    Jws<Claims> token = Jwts.parser().setClock(this).setSigningKey(key).parseClaimsJws(jwt);
    return token;
  }
