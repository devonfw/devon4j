...
/**
 * Interface for {@link AbstractWebSecurityConfig} as aspect. There can be any number of implementations of this
 ...
 * @since 2020.12.001
 */
public interface WebSecurityConfigAspect extends AbstractWebSecurityConfig {
