 ...
 * master-data. In that case you typically have a limited number of entities in your persistent store and need
 * operations like {@link #findAll()}.<br>
 * <b>ATTENTION:</b><br>
 ...
 *
 */
public interface RevisionedMasterDataDao<E extends RevisionedPersistenceEntity<Long>>
