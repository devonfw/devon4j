...
To address the above, devonfw microservices has an alternative approach xref:alternative-microservice-netflix.adoc[Microservices based on Netflix-Tools].