...
https://docs.oracle.com/javase/8/docs/technotes/guides/management/agent.html[JMX] (Java Management Extensions) is the official Java xref:guide-monitoring.adoc[monitoring] solution.
...
Today, xref:guide-configuration.adoc[configuration] and xref:guide-monitoring.adoc[monitoring] are clearly separated aspects and should not be mixed.
