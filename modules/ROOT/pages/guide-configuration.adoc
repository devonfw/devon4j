...
For more detail of xref:spring.adoc[Spring] stack, see link:spring/guide-spring-configuration.adoc#internal-application-configuration[here]
...
For xref:spring.adoc[Spring], we use https://github.com/ulisesbocchio/jasypt-spring-boot#jasypt-spring-boot[jasypt-spring-boot]. For more details, see link:spring/guide-spring-configuration.adoc#password-encryption[here]

For xref:quarkus.adoc[Quarkus], see link:quarkus/guide-quarkus-configuration.adoc#password-encryption[here]
