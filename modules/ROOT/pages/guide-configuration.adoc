...
For more detail of link:spring.adoc[Spring] stack, see link:spring/guide-spring-configuration.asciidoc#internal-application-configuration[here]
...
For link:spring.adoc[Spring], we use https://github.com/ulisesbocchio/jasypt-spring-boot#jasypt-spring-boot[jasypt-spring-boot]. For more details, see link:spring/guide-spring-configuration.asciidoc#password-encryption[here]

For link:quarkus.adoc[Quarkus], see link:quarkus/guide-quarkus-configuration.asciidoc#password-encryption[here]
