...
== Datatype Packaging
For the devonfw we use a common link:coding-conventions.adoc#packages[packaging schema].
...
The usage of custom datatypes in entities is explained in the link:guide-jpa.adoc#entities-and-datatypes[persistence layer guide].
