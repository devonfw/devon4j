...
As a simplification Embeddables do not require a separate interface and link:guide-transferobject.asciidoc#ETO[ETO] as the link:guide-beanmapping.adoc[bean-mapper] will create a copy automatically when converting the owning entity to an ETO.
...
For link:spring.adoc[spring] see link:spring/guide-spring-configuration.asciidoc#database-configuration[here].

For link:quarkus.adoc[quarkus] see link:quarkus/guide-quarkus-configuration.asciidoc#database-configuration[here].
