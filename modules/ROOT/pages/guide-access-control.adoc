...
For xref:spring.adoc[spring], check the link:spring/guide-authentication-spring.adoc[Spring Security]

For xref:quarkus.adoc[quarkus], check the link:quarkus/guide-authentication-quarkus.adoc[Quarkus Authentication]
