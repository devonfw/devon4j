...
For general guides on dealing or avoiding SQL, preventing SQL-injection, etc. you should study xref:guide-domain-layer.adoc[domain layer].
...
See also xref:guide-database-migration.adoc[Database Migrations].
