...
Examples for such standards are link:guide-jpa.adoc[JPA], link:guide-rest.asciidoc#jax-rs[JAX-RS], link:guide-soap.asciidoc#jax-ws[JAX-WS], link:guide-dependency-injection.adoc[JSR330], link:guide-access-control.adoc[JSR250], link:guide-xml.asciidoc#jaxb[JAX-B], etc.
