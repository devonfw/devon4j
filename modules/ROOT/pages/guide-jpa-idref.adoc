...
In order to easily map relations from entities to link:guide-transferobject.adoc[transfer-objects] and back, we can easily also put according getters and setters into our entities:
...
when link:tutorial-newapp.adoc[creating a devon4j app].
