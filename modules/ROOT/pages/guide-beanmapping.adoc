...
For a xref:spring.adoc[devon4j-spring] application we recommend Orika, follow link:spring/guide-beanmapping-spring.adoc[Spring Bean-Mapping] for an introduction to Orika and Dozer in a devon4j-spring context application.
...
For a xref:quarkus.adoc[Quarkus] application we recommend Mapstruct, follow link:quarkus/guide-beanmapping-quarkus.adoc[Quarkus Bean-Mapping] for an introduction to Mapstruct in a quarkus context application.
