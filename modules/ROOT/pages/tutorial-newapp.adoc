...
* `batch`: optional module for link:guide-batch-layer.adoc[batch](es)
...
* Profiles for link:guide-testing.adoc[test stages]
...
More details are available link:guide-structure.adoc#make-jar-not-war[here].
