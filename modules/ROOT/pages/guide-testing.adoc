...
The following picture shows a simplified view of an application based on the xref:architecture.adoc#technical-architecture[devonfw reference architecture]. We define four integration levels that are explained in detail below. 
