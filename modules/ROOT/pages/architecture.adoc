...
|link:guide-service-layer.adoc[service]|link:guide-service-layer.asciidoc#soap[SOAP services]|https://jcp.org/en/jsr/detail?id=224[JAX-WS]|http://cxf.apache.org/[CXF]
|link:guide-service-layer.adoc[service]|link:guide-service-layer.asciidoc#rest[REST services]|https://jax-rs-spec.java.net/[JAX-RS]| http://cxf.apache.org/[CXF]
