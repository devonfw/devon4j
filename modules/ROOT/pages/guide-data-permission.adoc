...
=== Beware of AOP
For simple but cross-cutting data-permissions you may also use xref:guide-aop.adoc[AOP]. This leads to programming aspects that reflectively scan method arguments and magically decide what to do. Be aware that this quickly gets tricky:
