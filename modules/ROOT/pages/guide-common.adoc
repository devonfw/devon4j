...
In our link:coding-conventions.adoc[coding-conventions] we define a clear link:coding-conventions.asciidoc#packages[packaging] and link:coding-conventions.asciidoc#layers[layering].
