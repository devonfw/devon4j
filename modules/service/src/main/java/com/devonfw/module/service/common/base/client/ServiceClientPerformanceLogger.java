...
public abstract class ServiceClientPerformanceLogger {
   ...
   */
  public static void log(long startTime, Object service, int statusCode, Throwable error) {
    ...
    if ((error != null) || (statusCode >= 400)) {
      LOG.warn("Invoking service {} took {} and failed with status {}.", service, duration, status, error);
    } else {
      LOG.info("Invoking service {} took {} and succeded with status {}.", service, duration, status);
    }
  }
