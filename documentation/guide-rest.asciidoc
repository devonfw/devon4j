...
|Pagination |Standardized format for a service to offer paginated access to a list of entities| Server-side support for pagination is documented in the link:guide-dataaccess-layer.asciidoc#pagination[Data-Access Layer Guide].
|=======
