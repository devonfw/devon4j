...
The technical data model is defined in form of link:guide-dataaccess-layer.asciidoc#entity[persistent entities].
...
The link:guide-logic-layer.asciidoc[logic layer] defines these transfer-objects (ETOs, CTOs, etc.) and will only pass such objects instead of link:guide-dataaccess-layer.asciidoc#entity[persistent entities].
