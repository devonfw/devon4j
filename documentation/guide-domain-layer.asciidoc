...
Note: The domain layer is the replacement for the link:guide-data-access-layer.asciidoc[data-access layer] in the link:guide-structure-modern.asciidoc[modern project structure].
