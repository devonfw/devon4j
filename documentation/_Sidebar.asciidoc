...
=== Guides
* link:guide-dependency-injection.asciidoc[Bean Dependency Injection]
...
=== devonfw Development 
* link:devonfw-ide-setup.asciidoc[Setup devonfw IDE]
* link:devonfw-issue-work.asciidoc[Issue creation & resolution]
* link:devonfw-code-contribution.asciidoc[Contribution of code]
* link:devonfw-documentation.asciidoc[Contribution to documentation]
...
=== For Core-Developers
* link:devonfw-release.asciidoc[Release Process]
