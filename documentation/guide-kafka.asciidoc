...
// TODO SSp: I would remove this chapter, normally users do not have to mess around with the spring configs and just import the starters (as you described in a following chapter)
...
// TODO SSp: How can people find out which properties are available and what do they mean?
...
[source]
----
<application name>-<service name>-<version>-<service-
 operation>
----
...
// TODO SSp: please move the following paragraphs to the health check chapter.
