...
messaging.retry.default.back-off-policy.retryReEnqueueDelay.employeeapp-employee-v1-delete=1000
messaging.retry.default.back-off-policy.retryDelay.employeeapp-employee-v1-delete=600000
messaging.retry.default.back-off-policy.retryDelayMultiplier.employeeapp-employee-v1-delete=1.0
messaging.retry.default.back-off-policy.retryMaxDelay.employeeapp-employee-v1-delete=600000
messaging.retry.default.back-off-policy.retryCount.employeeapp-employee-v1-delete=2

# default retry policy properties
messaging.retry.default.retry-policy.retryPeriod.employeeapp-employee-v1-delete=1800
messaging.retry.default.retry-policy.retryableExceptions.employeeapp-employee-v1-delete=<Class names of exceptions for which a retry should be performed>
messaging.retry.default.retry-policy.retryableExceptionsTraverseCauses.employeeapp-employee-v1-delete=true

# Retry back off policy properties
messaging.retry.default.back-off-policy.retryReEnqueueDelay.employeeapp-employee-v1-add=1000
messaging.retry.default.back-off-policy.retryDelay.employeeapp-employee-v1-add=600000
messaging.retry.default.back-off-policy.retryDelayMultiplier.employeeapp-employee-v1-add=2.0
messaging.retry.default.back-off-policy.retryMaxDelay.employeeapp-employee-v1-add=600000
messaging.retry.default.back-off-policy.retryCount.employeeapp-employee-v1-add=4

# default retry policy properties
messaging.retry.default.retry-policy.retryPeriod.employeeapp-employee-v1-add=3000
messaging.retry.default.retry-policy.retryableExceptions.employeeapp-employee-v1-add=<Class names of exceptions for which a retry should be performed>
messaging.retry.default.retry-policy.retryableExceptionsTraverseCauses.employeeapp-employee-v1-add=true
-----
