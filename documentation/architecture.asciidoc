...
image::images/t-architecture.png["Technical architecture", width="450"]
...
This is illustrated by the horizontal connectors. Please note that link:guide-dataaccess-layer.asciidoc#entity[persistence entities] are part of the API of the data-access component part so only the logic component part of the same
