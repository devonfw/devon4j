...
* link:guide-domain-layer.asciidoc[domain layer] for the data access, especially (in the link:guide-structure-modern.asciidoc[classic project structure] this layer is named link:guide-dataaccess-layer.asciidoc[data-access layer]).
