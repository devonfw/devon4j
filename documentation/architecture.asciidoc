...
We reflect this architecture in our code as described in our link:coding-conventions[coding conventions] allowing a traceability of business components, use-cases, layers, etc. into the code and giving
