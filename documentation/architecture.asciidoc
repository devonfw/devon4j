...
We reflect this architecture in our code as described in our link:coding-conventions.asciidoc[coding conventions] allowing a traceability of business components, use-cases, layers, etc. into the code and giving
...
This is illustrated by the horizontal connectors. Please note that link:guide-jpa.asciidoc[persistence entities] are part of the API of the data-access component part so only the logic component part of the same
...
|link:guide-service-layer.asciidoc[service]|link:guide-service-layer.asciidoc[SOAP services]|https://jcp.org/en/jsr/detail?id=224[JAX-WS]|http://cxf.apache.org/[CXF]
|link:guide-service-layer.asciidoc[service]|link:guide-service-layer.asciidoc[REST services]|https://jax-rs-spec.java.net/[JAX-RS]| http://cxf.apache.org/[CXF]
