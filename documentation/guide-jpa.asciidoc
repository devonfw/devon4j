...
For link:spring.asciidoc[spring] see link:guide-configuration.asciidoc#database-configuration[here].

For link:quarkus.asciidoc[quarkus] see link:quarkus/guide-configuration.asciidoc#database-configuration[here].
