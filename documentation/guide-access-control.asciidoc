...
For link:spring.asciidoc[spring], we use https://projects.spring.io/spring-security/[spring-security] as a framework for authentication purposes.
...
For link:quarkus.asciidoc[quarkus], you can use different extensions for support of different authentication mechanisms. For example:
...
https://docs.spring.io/spring-security/site/docs/current/reference/htmlsingle/#multiple-httpsecurity[here] for spring or https://quarkus.io/guides/security#combining-authentication-mechanisms[here] for quarkus.
