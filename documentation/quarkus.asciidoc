...
* If you are completely new to Quarkus, you may be interested in the link:quarkus.asciidoc#pros[pros] and link:quarkus.asciidoc#cons[cons] of Quarkus. Also take a look at the link:https://quarkus.io[official Quarkus website]. And you might also be interested in the features that link:https://www.graalvm.org/[GraalVM] offers.
