...
* If you are completely new to Quarkus, you may be interested in the xref:pros[pros] and xref:cons[cons] of Quarkus. Also take a look at the link:https://quarkus.io/g[offical Quarkus website]. And you might also be interested in the features that link:https://www.graalvm.org/[GraalVM] offers.
