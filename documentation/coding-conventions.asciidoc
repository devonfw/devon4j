...
| «layer» | The name of the technical layer (See link:architecture.asciidoc[technical architecture]). Details are described for the link:guide-structure-modern.asciidoc#layers[modern project structure] and for the link:guide-structure-classic.asciidoc[classic project structure]. | `logic`
