...
The sending of JMS messages is considered like any other sending of data like link:guide-kafka.asciidoc[kafka] messages or RPC calls via link:guide-rest.asciidoc[REST] using link:guide-service-client.asciidoc[service-client], gRPC, etc.
