...
You need to make your choice for a database. Options are documented link:https://github.com/devonfw/devonfw-guide/blob/master/general/db/guide-database.asciidoc[here].
