...
Often deleting out-dated data is done by invoking a single SQL statement. It is appropriate to implement that SQL in a link:guide-dataaccess-layer.asciidoc#data-access-object[DAO] method and call this method directly from the batch.
