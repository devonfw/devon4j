...
For link:quarkus.asciidoc[quarkus] you can simply integrate app monitoring and health check via https://quarkus.io/guides/smallrye-health[smallrye-health].
