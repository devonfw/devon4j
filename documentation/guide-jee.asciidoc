...
link:quarkus.asciidoc[Quarkus] already supports this and also link:spring.asciidoc[spring]-boot starting with version `2.6` so for new projects you should consider to directly use only JakartaEE.
