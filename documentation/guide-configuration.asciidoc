...
Different algorithms can be used for stronger encryption, here in this example we are using PBEWITHMD5ANDTRIPLEDES.
----
...
3fOgrTkUy/LZZsbY81ILev59o0kHHOkk2NzSl8mbWBg=
...
```
spring.datasource.password=ENC(3fOgrTkUy/LZZsbY81ILev59o0kHHOkk2NzSl8mbWBg=)
...
Our recommendation is to use the default (PBEWITHHMACSHA512ANDAES_256), which means algorithm need not be specified while encrypting or decrypting.
