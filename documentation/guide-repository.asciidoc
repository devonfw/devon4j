...
The fragment approach is a bit laborious, as always three types (repository interface, fragment interface and fragment implementation) are needed to implement custom methods.
