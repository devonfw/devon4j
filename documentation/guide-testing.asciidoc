...
* Use in Spring http://joel-costigliola.github.io/assertj/[AssertJ] to write good readable and maintainable tests that also provide valuable feedback in case a test fails. Do not use legacy JUnit methods like `assertEquals` anymore!
...
Quarkus and Spring use different technologies for test automation. For more information click on the desired guide:

* link:https://devonfw.com/website/pages/docs/devon4j.wiki_devon4j.asciidoc_guides.html#guide-for-testing-spring.asciidoc[Spring Testing Guide]

* link:https://devonfw.com/website/pages/docs/devon4j.wiki_devon4j.asciidoc_guides_2.html#guide-for-testing.asciidoc[Quarkus Testing Guide]
...
Spring and Quarkus use different approaches to using mocks. For more information, click the desired guide:
...
Quarkus does not use integration levels , instead it tests different profiles. More details in link:https://devonfw.com/website/pages/docs/devon4j.wiki_devon4j.asciidoc_guides_2.html#guide-for-testing.asciidoc[Quarkus Testing Guide]
...
Spring and Quarkus also differ from each other in the test configuration. For more information, such as the use of beans, click on the corresponding guide
