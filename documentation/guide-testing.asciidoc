...
* link:guide-for-testing.asciidoc[Quarkus Testing Guide]
...
Quarkus does not use integration levels , instead it tests different profiles. More details in link:guide-for-testing.asciidoc[Quarkus Testing Guide] 
