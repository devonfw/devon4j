= spring 
:description: comprehensive documentation for spring stack of devonfw.
:doctype: book
:toc:
...
include::guide-structure.asciidoc[leveloffset=1]
...
include::guide-configuration-mapping.asciidoc[leveloffset=3]
...
include::guide-access-control-schema.asciidoc[leveloffset=2]

<<<<

include::guide-data-permission.asciidoc[leveloffset=3]

<<<<

include::guide-jwt.asciidoc[leveloffset=2]

<<<<

include::guide-csrf.asciidoc[leveloffset=2]
