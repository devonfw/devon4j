...
The following sections contain the complete compendium of https://github.com/devonfw/devon4j/[devon4j], the Java stack of devonfw. devon4j is divided into two stacks, one for spring-boot and one for quarkus.
