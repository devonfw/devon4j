...
https://code.quarkus.io/?g=org.devonfw&e=resteasy&e=resteasy-jackson&e=hibernate-validator&e=hibernate-orm&e=micrometer[Quarkus Code Generator] provides many alternative technologies and libraries that can be integrated into a project. Detailed guides on multiple topics can be found https://quarkus.io/guides/[here].

Due to the large selection of libraries, getting started can be difficult for developers.
Therefore, we aim to provide general suggestions on basic frameworks, libraries, and technologies to make it easy for developer to get started.
...
If you are new to Quarkus, consider checking out their https://quarkus.io/guides/getting-started[getting started guide] to get an overview on how to create, run, test, as well as package a Quarkus application. Another recommended source to get started are https://www.katacoda.com/openshift/courses/developing-with-quarkus/getting-started[the Katacoda tutorials].
