...
To get a first introduction to Quarkus, you can read the link:https://devonfw.com/website/pages/docs/quarkus.asciidoc.html[Quarkus introduction guide]. To get a brief overview of where you can find the important Quarkus related guides, follow the chapter link:https://devonfw.com/website/pages/docs/quarkus.asciidoc_guide-to-the-reader.html[guide to the reader].
Also, see the comparison of the link:https://devonfw.com/website/pages/docs/devon4j.wiki_quarkus.asciidoc_pros_2.html[advantages] and link:https://devonfw.com/website/pages/docs/devon4j.wiki_quarkus.asciidoc_cons_4.html[disadvantages] of a Quarkus application compared to the alternative framework Spring.
...
We provide a recommendation and guideline for a link:https://devonfw.com/website/pages/docs/guide-structure-modern.asciidoc.html[modern project structure] to help organize your project into logically related modules.
...
This guide shows how to link:https://devonfw.com/website/pages/docs/guide-migration-spring-quarkus.asciidoc.html[migrate a Spring application to a Quarkus application with devon4j conventions]. 
