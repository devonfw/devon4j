...
To get the first introduction to Quarkus you can read the link:../quarkus.asciidoc[Quarkus introduction guide]. To get a short overview where you can find the important Quarkus related guides follow the chapter link:../quarkus.asciidoc#guide-to-the-reader[guide to the reader].
...
We recommend installing the devonfw-ide with the tools, but if you already got your system configured and the tools from above installed you can skip to link:getting-started-quarkus.asciidoc#bootstrap-quarkus-project[Bootstrap a Quarkus Project] otherwise we will show you how to setup and update your devonfw-ide.
...
In that case there is our link:../guide-database-migration.asciidoc[general migration guide] can give you an overview if you are not familiar with migration.
...
[Note]
====
For more information to the different executables go back to the chapter link:getting-started-quarkus.asciidoc#Packaging-of-a-Quarkus-application-and-creation-of-a-native-executable[Packaging of a Quarkus application and creation of a native executable] //TODO
====
