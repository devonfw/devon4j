...
[source,bash]
---- 
mvn -DarchetypeVersion=3.0.0 -DarchetypeGroupId=com.devonfw.java.templates -DarchetypeArtifactId=devon4j-template-server archetype:generate -DgroupId=com.devonfw.application -DartifactId=sampleapp -Dversion=0.1.0-SNAPSHOT -Dpackage=com.devonfw.application.sampleapp 
---- 
...
image::images/Start-a-new-application/new_maven_project_version.PNG[scaledwidth="80%",align="center"]
...
image::https://cloud.githubusercontent.com/assets/11404205/7963678/43421092-0a14-11e5-86a1-ed9202674339.PNG[EAR]
