...
* https://github.com/devonfw/devon4j/issues/581[#581]: Release with latest minor versions (spring-boot 2.7.6)

The full list of changes for this release can be found in https://github.com/devonfw/devon4j/milestone/22?closed=1[milestone devon4j 2020.12.001].
...
The full list of changes for this release can be found in https://github.com/devonfw/devon4j/milestone/21?closed=1[milestone devon4j 2020.04.003].
