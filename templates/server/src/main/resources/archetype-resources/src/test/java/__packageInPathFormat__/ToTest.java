...
import ${package}.general.common.to.AbstractTo;
import nl.jqno.equalsverifier.EqualsVerifier;
import nl.jqno.equalsverifier.Warning;
import nl.jqno.equalsverifier.api.SingleTypeEqualsVerifierApi;

public class ToTest extends Assertions {
  ...
  private void testEqualsAndHashcode(Class<?> clazz, SoftAssertions assertion, ToExclusion exclusion) {
    ...
    SingleTypeEqualsVerifierApi<?> verifier = EqualsVerifier.forClass(clazz).withRedefinedSuperclass().usingGetClass()
  ...
  private List<Class<?>> getToClasses() {
    ...
    Set<BeanDefinition> toSet = provider.findCandidateComponents(ToTest.class.getPackageName());
